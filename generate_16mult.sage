...
if 'data' not in vars():
        data = {
                16: sage.geometry.lattice_polytope.read_all_polytopes("/home/jhhalverson/KS4/h11_16.txt"),
                32: sage.geometry.lattice_polytope.read_all_polytopes("/home/jhhalverson/KS4/h11_32.txt"),
                48: sage.geometry.lattice_polytope.read_all_polytopes("/home/jhhalverson/KS4/h11_48.txt")
        }
...
for p in data[h11][starter:starter+num_ex]:
        ...
        if exists1 == False and exists2 == False and isfavorable(pd):
                ...
                if True:#try:
                        ...
                        # kabc = [[[1/8*((Aab[a][b]*J0[c]) + (Aab[a][c]*J0[b]) + (Aab[b][c]*J0[a]) -J0[a]*J0[b]*J0[c]/2 +
                        #  Sabc[a][b][c])
                        # for a in range(h11)] for b in range(h11)] for c in range(h11)]
