...
# This file was *autogenerated* from the file generate_topological_local_more.sage
from sage.all_cmdline import *   # import sage library

_sage_const_40 = Integer(40); _sage_const_2 = Integer(2); _sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_737 = Integer(737); _sage_const_6 = Integer(6); _sage_const_5 = Integer(5); _sage_const_4 = Integer(4); _sage_const_3 = Integer(3); _sage_const_10 = Integer(10); _sage_const_4p0 = RealNumber('4.0'); _sage_const_30 = Integer(30); _sage_const_20 = Integer(20); _sage_const_50 = Integer(50)
import time
import numpy as np
import os.path
...
for pp in range(_sage_const_737 ,end):
        p = data[h11][pp]
            ...
            if isfavorable(pd):
                    ...
                    try:
                            ...
                            for ii in range(len(moricoeff)):
                                    ...
                                    plin.add_constraint(curve >= _sage_const_1 )
                            plin.solve()
                    ...
                    alldata.append(len(tv.fan().cones(_sage_const_2 )))
                    alldata.append(len(tv.fan().cones(_sage_const_3 )))
                    alldata.append(len(tv.fan().cones(_sage_const_4 )))
