...
# This file was *autogenerated* from the file generate_topological_local.sage
from sage.all_cmdline import *   # import sage library

_sage_const_40 = Integer(40); _sage_const_2 = Integer(2); _sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_3 = Integer(3); _sage_const_10 = Integer(10); _sage_const_30 = Integer(30); _sage_const_20 = Integer(20); _sage_const_50 = Integer(50)
import time
import numpy as np
import os.path
...
h11 = int(sys.argv[_sage_const_1 ]) ### note 10 is upper right window
print 'h11 ', h11
alldatas = []
numrays = []
import uuid
...
import os
for pp in range(_sage_const_0 ,len(data[h11])):
        p = data[h11][pp]
